...
def _rms_kernel(r_ptr, rms_ptr, M, K, eps, BLOCK_K: tl.constexpr):
    ...
    tl.store(rms_ptr + pid_m, tl.math.rsqrt(sq / K + eps))


@triton.jit
def _partial_kernel(
    r_ptr, fn_ptr, part_ptr,
    M, N, K, SPLIT_K,
